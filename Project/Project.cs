    ...
    public static class Project
    {
        ...
        private static IHandlerBuilder GetContent()
        {
            return Layout.Create()
                         ...
                         .AddMarkdownPage("client-caching", "ClientCaching", "Client Caching", "Instructs clients to validate their cache when requesting resources to save bandwith and resources.")
